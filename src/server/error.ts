...
export class LeviathanError extends Error {}

export class LeviathanSrcNotFoundError extends LeviathanError {}

export class LeviathanExecutionError extends LeviathanError {}
